...
After #tool:runSubagent returns avoid additional tool calls unless (a) a referenced file wasn’t retrieved, (b) there’s a contradiction, or (c) a key unknown blocks planning. If so, make at most 1–2 targeted tool calls.”!
